#!/usr/bin/env Rscript
# ==============================================================================
# SAIGE Step 2 -- Run R Reference for sparseGRM model (quantitative)
# ==============================================================================
#
# Purpose:
#   Run SAIGE Step 2 single-variant association via SPAGMMATtest()
#   using the quantitative sparse GRM example model. This generates
#   R reference output for comparison with the standalone C++ port.
#
...
#
# Usage:
#   Rscript run_r_step2_sparse.R
#   OR via pixi:
#   ~/.pixi/bin/pixi run --manifest-path=.../pixi.toml Rscript run_r_step2_sparse.R
#
# Output:
#   r_step2_sparse_results.txt -- SPAGMMATtest single-variant results
#
# ==============================================================================
...
vr_file     <- file.path(base_dir, "SAIGE/extdata/output/example_quantitative_sparseGRM.varianceRatio.txt")
...
output_file <- file.path(output_dir, "r_step2_sparse_results.txt")

# --- Preflight checks ---------------------------------------------------------

cat("=== SAIGE Step 2: R Reference Run (Sparse GRM, Quantitative) ===\n\n")
...
# ==============================================================================
# Run SAIGE Step 2 (single-variant association test)
# ==============================================================================

cat("--- Running SPAGMMATtest (sparse GRM, LOCO=FALSE) ---\n\n")
