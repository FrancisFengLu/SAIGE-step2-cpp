#!/usr/bin/env Rscript
# ==============================================================================
# SAIGE Step 2 -- Region/Gene-based Testing (Quantitative Trait)
# ==============================================================================
#
# Purpose:
#   Run SAIGE Step 2 region-based association (BURDEN/SKAT/SKAT-O) via
#   SPAGMMATtest() on the quantitative example data and save reference output.
#
# Usage:
#   Rscript run_r_step2_region.R
#
# Output:
#   r_step2_region_results.txt          -- Region-level p-values
#   r_step2_region_results.txt.singleAssoc.txt -- Single-variant within groups
#
# ==============================================================================
...
# Output paths
output_file <- file.path(checkpoint_dir, "r_step2_region_results.txt")

# --- Preflight checks ---------------------------------------------------------

cat("=== SAIGE Step 2: R Region-Based Test ===\n\n")
...
# ==============================================================================
# Run SAIGE Step 2: Region-based association test
# ==============================================================================

cat("--- Running SPAGMMATtest (region-based) ---\n\n")
